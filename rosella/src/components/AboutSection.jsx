...
const AboutSection = () => {
    return (
        <section className="py-16 md:py-24 relative overflow-hidden" id="about">
            <div className="absolute top-1/2 left-0 -translate-y-1/2 w-[500px] h-[500px] bg-[#db2777]/5 rounded-full blur-3xl -z-10"></div>
            ...
            <div className="max-w-[1200px] mx-auto px-4 grid md:grid-cols-2 gap-16 items-center">
                ...
                <div className="relative">
                    <div className="relative z-10 rounded-[3rem] overflow-hidden shadow-2xl border-8 border-white">
                        ...
                        />
                        <div className="absolute inset-0 bg-gradient-to-t from-[#db2777]/20 to-transparent mix-blend-overlay"></div>
                    </div>
