...
const ContactSection = () => {
    return (
        <section className="py-20 px-4 relative overflow-hidden bg-accent-maroon">
            ...
            <div className="absolute top-0 right-0 w-96 h-96 bg-primary/30 rounded-full blur-3xl transform translate-x-1/3 -translate-y-1/3"></div>
                    ...
                    <div className="space-y-6">
                        {contactInfo.map((info, index) => (
                            <div key={index} className="flex items-center gap-4 text-text-main group">
                                <div className="size-10 rounded-full bg-background-light flex items-center justify-center group-hover:bg-primary group-hover:text-white transition-colors">
                ...
                <div className="bg-[#fdf2f8] p-12 md:w-1/2 flex flex-col justify-center relative">
                    ...
                    <form className="space-y-5 relative z-10">
                        <div>
                            ...
                            <input className="w-full bg-white border border-secondary/20 rounded-xl px-4 py-3.5 focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-shadow shadow-sm" placeholder="Your Name" type="text" />
                        </div>
                        <div>
                            <label className="block text-xs font-bold text-secondary uppercase tracking-wider mb-2">Event Date</label>
                            <input className="w-full bg-white border border-secondary/20 rounded-xl px-4 py-3.5 focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-shadow shadow-sm" type="date" />
                        </div>
                        <div>
                            <label className="block text-xs font-bold text-secondary uppercase tracking-wider mb-2">Guest Count (Approx)</label>
                            <select className="w-full bg-white border border-secondary/20 rounded-xl px-4 py-3.5 focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-shadow shadow-sm text-gray-600">
                        ...
                        <button className="w-full bg-gradient-to-r from-primary to-[#c48b4e] hover:to-primary text-white font-bold py-4 rounded-xl mt-6 transition-all shadow-md hover:shadow-lg transform active:scale-95" type="button">
                            Check Availability
                        </button>
                    </form>
                </div>
