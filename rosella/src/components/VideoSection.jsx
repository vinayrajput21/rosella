    ...
    return (
        <section className="py-12 px-4 relative">
            <div className="max-w-[1000px] mx-auto text-center relative z-10">
                ...
                <h2 className="text-3xl md:text-5xl font-serif font-bold text-[#581c2f] mb-10">Experience the Grandeur</h2>
                <div className="relative aspect-video w-full rounded-[2rem] overflow-hidden shadow-glow group cursor-pointer bg-[#2d0814] border-4 border-white/50">
                    ...
                    ></div>
                    <div className="absolute inset-0 bg-[#9d174d]/20 mix-blend-overlay"></div>
