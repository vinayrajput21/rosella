                ...
                <div className="relative rounded-2xl overflow-hidden min-h-[650px] flex items-end justify-start p-8 md:p-16 group shadow-2xl shadow-accent-maroon/20 border-4 border-white/30">
                    ...
                    <div className="relative z-10 max-w-3xl text-white animate-fade-in-up">
                        <div className="flex items-center gap-2 mb-6">
                            <span className="px-4 py-1.5 bg-white/10 backdrop-blur-md border border-white/30 rounded-full text-xs uppercase tracking-wider font-semibold text-primary flex items-center gap-2 shadow-sm">
                        ...
                        <h1 className="text-5xl md:text-7xl font-serif font-bold leading-[1.1] mb-6 tracking-tight drop-shadow-lg">
                            Celebrate Your <br /> <span className="italic text-primary font-serif">Special Moments</span>
                        </h1>
                        ...
                        <div className="flex flex-col sm:flex-row gap-4">
                            <button className="bg-primary hover:bg-[#c48b4e] text-white text-base font-bold px-8 py-3.5 rounded-full transition-all shadow-lg shadow-primary/30 flex items-center justify-center gap-2 border border-white/20">
